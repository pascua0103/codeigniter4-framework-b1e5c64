...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    ...
    <h1>Jhowie Mhay P. Erestain</h1>
    <h1>Neildric B. Pascua</h1>
  </div>  
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="dashview" class="nav-link">Home</a>
      </li>
    </ul>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="dashview" class="nav-link active">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3 id = "product_price">0<sup style="font-size: 20px">%</sup></h3>
...
<script src="<?= base_url('assets/JS/Dashview8.js'); ?> "> </script>
